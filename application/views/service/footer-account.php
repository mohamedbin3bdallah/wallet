		...
		$(document).ready(function(){
			$("#name").focusout(function() {
				...
				else
				{
					$.ajax({
						type: 'POST',
						url: '<?php echo base_url(); ?>myaccount/name_validation',
						data: {
							'val':val,
							'id':id
							},
		...
		$(document).ready(function(){
			$("#email").focusout(function() {
				...
				else
				{
					$.ajax({
						type: 'POST',
						url: '<?php echo base_url(); ?>myaccount/email_validation',
						data: {
							'val':val,
							'id':id
							},
		...
		$(document).ready(function(){
			$("#password").focusout(function() {
				...
				else
				{
					$.ajax({
						type: 'POST',
						url: '<?php echo base_url(); ?>myaccount/password_validation',
						data: {
							'val1':val1,
							'val2':val2,
							},
		...
		$(document).ready(function(){
			$("#cnfpassword").focusout(function() {
				...
				else
				{
					$.ajax({
						type: 'POST',
						url: '<?php echo base_url(); ?>myaccount/cnfpassword_validation',
						data: {
							'val1':val1,
							'val2':val2,
							},
		...
		$(document).ready(function(){
			$("#username").focusout(function() {
				...
				else
				{
					$.ajax({
						type: 'POST',
						url: '<?php echo base_url(); ?>myaccount/username_validation',
						data: {
							'val':val,
							'id':id
							},
