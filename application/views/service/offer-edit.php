                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
					...
					<?php
						...
						echo form_open_multipart('service/offers/editoffer/'.$offer->ofid, $attributes);
					?>
					...
					?>
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 <?php echo $input_class; ?>">
						  <?php
							if(isset($offer->ofimg) && $offer->ofimg != '' && file_exists($this->config->item('offers_folder').$offer->ofimg))
							{ 
								?><img src="<?php echo base_url().$this->config->item('offers_folder').$offer->ofimg; ?>" class="img-responsive" style="max-width:150px;max-height:150px;"/><?php
								$data = array(
									'oldimg'  => $offer->ofimg
								);
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 <?php echo $input_class; ?>">
						  <?php
							...
							if($offer->ofactive == '1') $data['checked'] = 'TRUE';
