                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
					...
					<?php
						...
						echo form_open_multipart('service/editsettings/'.$this->item->iid, $attributes);
					?>
					...
					?>
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 <?php echo $input_class; ?>">
						  <?php
							if(isset($this->item->iimg) && $this->item->iimg != '' && file_exists($this->config->item('items_logos_folder').$this->item->iimg))
							{ 
								?><img src="<?php echo base_url().$this->config->item('items_logos_folder').$this->item->iimg; ?>" class="img-responsive" style="max-width:150px;max-height:150px;"/><?php
								$data = array(
									'oldimg'  => $this->item->iimg
								);
