<!-- footer content -->
	...
	<script>	$(document).ready(function(){		$("#usertype").change(function(){			var val = $(this).val();			if(val == 3)			{				document.getElementById('item').innerHTML = '<div class="form-group"><label for="type" class="'+$("#namelabel").attr('class')+'"><?php echo lang('type'); ?> <span class="required">*</span></label><div class="'+$("#namediv").attr('class')+'"><select name="type" class="form-control" required="required"><?php foreach($types as $type) { ?><option value="<?php echo $type->tyid; ?>"><?php echo $type->tytitle; ?></option><?php } ?></select></div></div><div class="form-group"><label for="title" class="'+$("#namelabel").attr('class')+'"><?php echo lang('title'); ?> <span class="required">*</span></label><div class="'+$("#namediv").attr('class')+'"><input type="text" name="title" value="" id="title" placeholder="<?php echo lang('title'); ?>" class="form-control col-md-7 col-xs-12"></div></div><div class="form-group"><label for="logo" class="'+$("#namelabel").attr('class')+'"><?php echo lang('logo'); ?> <span class="required">*</span></label><div class="'+$("#namediv").attr('class')+'"><input type="file" name="logo" id="logo" class="form-control col-md-7 col-xs-12"></div></div><div class="form-group"><label for="partnership" class="'+$("#namelabel").attr('class')+'"><?php echo lang('partnership'); ?> <span class="required">*</span></label><div class="'+$("#namediv").attr('class')+'"><select name="partnership" class="form-control" required="required"><?php foreach($partnerships as $partnership) { ?><option value="<?php echo $partnership->psid; ?>"><?php echo $partnership->pstitle; ?></option><?php } ?></select></div></div>';			}			else $("#item").html('');		});	});	</script>
	<script>
		$(document).ready(function(){
